...
class VersionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create version" do
    assert_difference('Version.count') do
      post versions_url, params: { version: { event: @version.event, item_id: @version.item_id, item_type: @version.item_type, object: @version.object, whodunnit: @version.whodunnit } }
    end
  ...
  test "should update version" do
    patch version_url(@version), params: { version: { event: @version.event, item_id: @version.item_id, item_type: @version.item_type, object: @version.object, whodunnit: @version.whodunnit } }
