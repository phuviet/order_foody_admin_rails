...
ActiveRecord::Schema.define(version: 20_180_409_171_048) do
  ...
  create_table 'api_keys', force: :cascade do |t|
    ...
    t.index %w[access_token user_id], name: 'index_api_keys_on_access_token_and_user_id', unique: true, where: '(deleted_at IS NULL)'
